<template>
  <div class="columns">
    ...
    <div class="column is-9">
      <div class="container about-container">
        <section class="section">
          <h1 class="title is-1" id="intro">This vessel does not exist.</h1>
          <div class="content">
            <div class="columns">
              <div class="column">
                <p>
        ...
        <section class="section">
          <h3 class="title is-3" id="mlgans">Machine Learning & GANs</h3>
          <div class="content">
            <div class="columns">
              <div class="column">
                <p>
        ...
        <section class="section">
          <h4 class="title is-4" id="stylegan2019">StyleGAN 1, June 2019</h4>
          ...
          <h5 class="title is-5" id="runningsg">Running StyleGAN</h5>
          <div class="content">
            <p>
          ...
          <h5 class="title is-5" id="gensamplessg1">Generated Samples</h5>
          ...
          <h5 class="title is-5" id="sg1qh"><em>Qinghua</em> (Blue & White)</h5>
          <div class="content">
            <p>
          ...
          <h5 class="title is-5" id="sg1diverse">Diverse</h5>
          <div class="content">
            <p>
        ...
        <section class="section">
          <h4 class="title is-4" id="sg2april">StyleGAN 2, April 2020</h4>
          <div class="container">
          ...
          <h5 class="title is-5 mt-4" id="sg2glaze">This Glaze Does Not Exist.</h5>
          ...
          <h5 class="title is-5" id="tvdnev2">"This Vessel Does Not Exist" Version 2</h5>
          ...
          <h5 class="title is-5" id="translern2">Transfer Learning</h5>
          ...
          <h5 class="title is-5" id="beetlevas2">Beetlevase</h5>
        ...
        <section class="section">
          <h4 class="title is-4" id="gpt3july">GPT-3, July 2020</h4>
          <div class="container">
            <div class="content">
              <p>
        ...
        <section class="section">
          <h4 class="title is-4" id="tiaqdne">This inspirational art quote does not exist.</h4>
          <div class="container">
            <div class="content">
              <p>
        ...
        <section class="section">
          <h4 class="title is-4" id="artquotes2">Art Quotes 2, December 2020 update</h4>
          <div class="container">
            <div class="content">
        ...
        <section class="section">
          <h4 class="title is-4" id="potteryhaikus">Pottery Haikus</h4>
          <div class="container">
            <div class="content">
              <p>
        ...
        <section class="section">
          <h4 class="title is-4" id="artstatements">Artist Statements</h4>
          <div class="container">
            <div class="content">
              <p>
        ...
        <section class="section">
          <h4 class="title is-4" id="genrecipedec">GPT-2 Generated Recipes, December 2020</h4>
          <div class="container">
            <div class="content">
              <p>
    ...
    SiO2: 44.64, Al2O3: 12.17, B2O3: 3.06, K2O: 0.07, Na2O: 4.76, MgO: 3.96, CaO: 7.55, P2O5: 2.08, Fe2O3: 8.72, TiO2: 0.06</pre>
        ...
        <section class="section">
          <h4 class="title is-4" id="genrecipemar">In the Real World!  Update, March 2021</h4>
          <div class="container">
            <div class="content">
              <p>
                The virtual is slowly seeping into the real.
                Glazy users have been posting some wonderful
                tests of glaze recipes generated by OpenAI's machine learning
                software GPT-2.  This is only the beginning!
              </p>
              <p>
                Glazy Recipe Links:
                <a href="https://glazy.org/recipes/133828">#133828</a>,
                <a href="https://glazy.org/recipes/133815">#133815</a>,
                <a href="https://glazy.org/recipes/133811">#133811</a>,
                <a href="https://glazy.org/recipes/112871">#112871</a>,
                <a href="https://glazy.org/recipes/111091">#111091</a>,
                <a href="https://glazy.org/recipes/110901">#110901</a>
              </p>
              <ModalImage
                imgUrl="/img/gpt-2/gpgglaze.jpg"
                caption='Generated glazes making their way into the real world.'
                />
            </div>
          </div>
        </section>
        ...
        <section class="section">
          <h4 class="title is-4" id="quickdraw">What is a Vase?  Google Quick, Draw!</h4>
          <div class="container">
            <div class="content">
              <p>
                <em>Exploring datasets, March, 2021</em>
              </p>
              <ModalImage
                imgUrl="/img/draw/samples.jpg"
                caption='Samples of "vases" from the Google Quick, Draw! dataset.'
                />
              <p>
                50 million doodles have been released as a dataset, including 126,475 drawings of a "vase".
                In this image I've stacked hundreds of "vase" doodles, revealing a common form.
              </p>
              <ModalImage
                imgUrl="/img/draw/allgoogledraw.jpg"
                caption='Left: Stacked "vase" doodles, Right: Differences across cultures.'
                />
              <p>
                But what emerges is not the universal, Platonic ideal of a "vase".  Google's analysis
                of doodle composites has shown that even for basic things like "chair" there are
                significant differences across cultures.  (Google AI & Kyle McDonald)
              </p>
              <p>
                You can browse the vase doodle dataset here:
                <a href="https://quickdraw.withgoogle.com/data/vase">https://quickdraw.withgoogle.com/data/vase</a>
              </p>
            </div>
          </div>
        </section>
        ...
        <section class="section">
          <h4 class="title is-4" id="sg3intro">Embryonic vessels. StyleGAN 3, October 2021</h4>
          <div class="container">
            <div class="content">
